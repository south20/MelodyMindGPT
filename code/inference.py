...
if __name__ == '__main__':
    ...
    args = {'model': 'southgpt',
            'southgpt_ckpt_path': '../ckpt/delta_ckpt/southgpt/7b_tiva_v0/',
            'max_length': 128,
            'stage': 3,
            'root_dir': '../',
            'mode': 'validate',
    ...
    delta_ckpt = torch.load(os.path.join(args['southgpt_ckpt_path'], 'pytorch_model.pt'), map_location=torch.device('cuda'))
    # print(delta_ckpt)
