...
def parser_args():
    ...
    parser.add_argument('--save_path', type=str, default='../ckpt/delta_ckpt/southgpt/7b_tiva_v0/')
    parser.add_argument('--log_path', type=str, default='../ckpt/delta_ckpt/southgpt/7b_tiva_v0/log/')
